...
import type { GoldFullDataset } from "@/lib/research/gold/goldDataOrchestrator";
...
export async function GET() {
  ...
  console.log(`[API /api/gold/data] Starting data collection...`);
  ...
  console.log(`[API /api/gold/data] Complete | Sources: ${sourceSummary.length} | Errors: ${errors.length}`);
